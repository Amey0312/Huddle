        ...
        <div className='max-w-7xl mx-auto my-10'>
            <div className='flex items-center justify-between'>
                <div>
                    ...
                    <h1 className='font-bold my-1'>Application Deadline:
                ...
                <Button
                    onClick={isApplied ? null : applyJobHandler} // Prevents calling the function
                    disabled={isApplied} // Prevents interaction
            ...
            <div className='my-4'>
                ...
                {/* <h1 className='font-bold my-1'>Requirement: <span className='pl-4 font-normal text-gray-800'>{singleJob?.requirements}</span></h1> */}
                <h1 className='font-bold my-1'>Requirements:</h1>
                <ul className='pl-6 list-disc text-gray-800'>
                    {Array.isArray(singleJob?.requirements)
                        ? singleJob.requirements.map((req, index) => (
                            <li key={index}>{req.trim()}.</li>
                        ))
                        : (singleJob?.requirements || '').split('.').filter(req => req.trim() !== '').map((req, index) => (
                            <li key={index}>{req.trim()}.</li>
                        ))
                    }
                </ul>
